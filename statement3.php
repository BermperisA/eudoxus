         ...
         <td width="859">
                ...
                <div id="services_form">
                  ...
                  <table style="margin-left:2%; margin-top:7%;" id="inform_table" width="95%" height="335" >
                    ...
                    <tr>
                      <td style="width:247; height:32; "><strong><u>Δήλωση Συγγραμμάτων</u></strong></td>
		     
		      <td  style="width: 500;   text-align: center; text-shadow: #909090  0.2em 0.3em 0.2em"><strong><u><h2> Μαθήματα που έχουν επιλεχθεί</h2></u></strong></td> 
		       <td   style=" width:200 ;" >   </td>
                    ...
                    <tr >
                         <td height="20" style="outline: thin solid black;" >     
                             <h3 style="text-align: center; text-shadow: #909090  0.2em 0.3em 0.2em">Μάθημα</h3>
                         </td>
                         
			 <td  style="outline: thin solid black;">  
                        
                             <h3 style="text-align: center; text-shadow: #909090  0.2em 0.3em 0.2em">Σύγγραμμα</h3>
                         
                         </td>

			  <td  style="outline: thin solid black;">  
                        
                            <h3 style="text-align: center; text-shadow: #909090  0.2em 0.3em 0.2em">Κωδικός Συγγράμματος</h3>
                  ...
                  <table style="margin-left:2%;">
                    ...
                    <tr>
                      <td width="710" height="89">
                         ...
                         <div id="profile_edit">
			    <input  style="position: relative; left: -250px;  padding: 0px; "  onClick="window.location.href='statement2.php';"  value="&#9668  Προηγούμενο Βήμα" id="editbt"><br>
                           <input  style="position: relative; left: 250px; padding: 0px; margin-top: -27px;" onClick="window.location.href='statement4.php';"  value="Υποβολή Δήλωσης &#10004 " id="editbt"><br>
                         </div>
		   ...
		   <tr>
                      <td width="100" height="89">
                        ...
                        <progress style="width:700px; margin-top: -100px;" value="75" max="100" ></progress>
